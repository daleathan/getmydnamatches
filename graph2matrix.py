...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Convert AncestryDNA/23andMe matches graph to matrix (26 Jun 2016)', add_help = False, usage = 'graph2matrix.py [options]')
